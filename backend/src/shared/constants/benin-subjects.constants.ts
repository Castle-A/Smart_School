...
export const BENIN_SUBJECTS_TEMPLATE: BeninSubjectTemplate[] = [
  ...
  {
    code: 'MAT_VIE_PRAT',
    name: "Activités d'éducation pour la santé (Vie Pratique)",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  {
    code: 'MAT_REFLEXE',
    name: "Activités d'éducation pour la santé (Éducation à la réflexe)",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  {
    code: 'MAT_ORAL',
    name: "Activités d'expression orale",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  {
    code: 'MAT_CORPO',
    name: "Activités d'expression corporelle",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  {
    code: 'MAT_PLAST',
    name: "Activités d'expression plastique",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  {
    code: 'MAT_EVEIL_ST',
    name: "Éducation d'éveil scientifique et technologique",
    cycle: 'MATERNELLE',
    defaultCoef: 0,
    category: 'ACTIVITE',
  },
  ...
  {
    code: 'PRI_EST',
    name: 'Éducation scientifique et technologique (EST)',
    cycle: 'PRIMAIRE',
    defaultCoef: 1,
    category: 'ÉVEIL',
  },
  ...
  {
    code: 'SEC_PCT',
    name: 'Physique-Chimie-Technologie (PCT)',
    cycle: 'COLLEGE_LYCEE',
    defaultCoef: 2,
    category: 'SCIENTIFIQUE',
  },
  ...
  {
    code: 'SEC_TECH_ADMIN',
    name: 'Techniques Administratives',
    cycle: 'LYCEE_TECHNIQUE',
    defaultCoef: 3,
    category: 'TECHNIQUE',
  },
