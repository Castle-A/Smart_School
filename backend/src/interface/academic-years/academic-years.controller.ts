...
export class AcademicYearsController {
    ...
    @Get('active')
    @Roles('FOUNDER', 'DIRECTOR', 'CENSOR', 'SECRETARY', 'ACCOUNTANT', 'TEACHER')
    async getActiveYear(@Request() req) {
    ...
    getYear(@Request() req, @Param('id') id: string) {
    ...
    @Roles('DIRECTOR')
    validateActiveYearClosure(@Request() req) {
    ...
    @Roles('FOUNDER', 'DIRECTOR')
    validateClosure(@Request() req, @Param('id') id: string) {
    ...
    @Post(':id/close')
    @Roles('FOUNDER', 'DIRECTOR')
    closeYear(@Request() req, @Param('id') id: string) {
    ...
    @Post(':id/archive')
    @Roles('FOUNDER')
    archiveYear(@Request() req, @Param('id') id: string) {
    ...
    @Get(':id/preview-next')
    @Roles('FOUNDER', 'DIRECTOR')
    previewTransition(@Request() req, @Param('id') id: string) {
    ...
    certifyMaternellePrimaire(@Request() req, @Param('id') id: string) {
    ...
    @Throttle({ default: { limit: 5, ttl: 60000 } }) // Max 5 requêtes par minute
    certifyCollegeLycee(@Request() req, @Param('id') id: string) {
    ...
    @Roles('ACCOUNTANT')
    @Throttle({ default: { limit: 5, ttl: 60000 } }) // Max 5 requêtes par minute
    certifyFinances(@Request() req, @Param('id') id: string) {
