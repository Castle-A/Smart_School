...
async function main() {
    ...
    const authService = new AuthService(authRepo, prismaService, jwtService, analyticsService);
    ...
    try {
        ...
        try {
            ...
            if (e.message.includes('désactivé')) console.log("SUCCESS: Caught expected error: " + e.message);
        ...
        try {
            ...
            if (e.message.includes('supprimé')) console.log("SUCCESS: Caught expected error: " + e.message);
            else console.error("FAILURE: Caught wrong error: " + e.message);
        }
