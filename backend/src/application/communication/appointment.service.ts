...
export class AppointmentService {
    ...
    async requestAppointment(schoolId: string, organizerId: string, dto: CreateAppointmentDto) {
    ...
    async validateParticipation(userId: string, appointmentId: string, status: 'ACCEPTED' | 'DECLINED') {
