...
export class CommunicationService {
    ...
    async createAnnouncement(schoolId: string, authorId: string, data: { title: string, content: string, scope: string }) {
    ...
    async sendPaymentReminder(schoolId: string, studentId: string, method: 'EMAIL' | 'SMS' = 'EMAIL') {
     ...
     */
    async sendSanctionAlert(schoolId: string, studentId: string, sanctionType: string) {
        const student = await this.prisma.student.findUnique({
            where: { id: studentId }
        });
