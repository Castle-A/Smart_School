...
@Module({
    ...
    controllers: [FinanceController, ExpensesController, PayrollController, TransactionsController],
    providers: [FinanceService, ExpensesService, PdfService, PayrollService, TransactionsService],
    exports: [FinanceService, ExpensesService, PdfService, PayrollService, TransactionsService],
})
