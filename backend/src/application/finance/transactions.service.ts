...
export class TransactionsService {
    ...
    async getHistory(schoolId: string, filters?: { startDate?: Date, endDate?: Date }) {
        ...
        const payrolls = await this.prisma.payroll.findMany({
            where: { schoolId, status: 'PAID', ...({ updatedAt: whereDate.date } as any) }, // Using updatedAt as payment date proxy if paymentDate null
