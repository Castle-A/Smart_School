...
import SecretaryOverviewSection from './secretary/SecretaryOverviewSection';
import SecretaryAdministrationSection from './secretary/SecretaryAdministrationSection';
import SecretarySchoolLifeSection from './secretary/SecretarySchoolLifeSection';
import SecretaryCurriculumSection from './secretary/SecretaryCurriculumSection';
import SecretaryCommunicationSection from './secretary/SecretaryCommunicationSection';
...
const SecretaryDashboard = () => {
    ...
    const renderContent = () => {
        ...
        switch (activeSection) {
            case 'vue_ensemble':
                return <SecretaryOverviewSection />;
            case 'administration':
                return <SecretaryAdministrationSection />;
            case 'vie_scolaire':
                return <SecretarySchoolLifeSection />;
            case 'programme_scolaire':
                return <SecretaryCurriculumSection />;
            case 'communication':
                return <SecretaryCommunicationSection />;
            default:
                return <SecretaryOverviewSection />;
        }
    };
