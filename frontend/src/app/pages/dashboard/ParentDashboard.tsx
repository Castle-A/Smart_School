...
import ParentSchoolLifeSection from './parent/ParentSchoolLifeSection';
import ParentCurriculumSection from './parent/ParentCurriculumSection';
import ParentCommunicationSection from './parent/ParentCommunicationSection';
...
const ParentDashboard = () => {
    ...
    const [activeSection, setActiveSection] = useState<MenuItemId | 'settings'>('programme_scolaire');
    ...
    const handleBackToDashboard = () => {
        ...
        setActiveSection('programme_scolaire');
    ...
    const renderContent = () => {
        ...
        switch (activeSection) {
            case 'vie_scolaire':
                return <ParentSchoolLifeSection />;
            case 'programme_scolaire':
                return <ParentCurriculumSection />;
            case 'communication':
                return <ParentCommunicationSection />;
            default:
                return <ParentCurriculumSection />;
        }
    };
