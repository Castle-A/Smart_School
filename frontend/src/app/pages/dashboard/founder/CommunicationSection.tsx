                ...
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                            ...
                            <span className="px-2 py-1 bg-white/5 text-gray-400 text-xs rounded-full border border-white/10">Par rôle</span>
                        </div>
                    </div>
                    ...
                    <button className="w-full mt-4 py-2 text-sm text-gray-400 hover:text-white border border-white/5 hover:border-white/20 rounded-lg transition-colors">
                        ...
                        <div className="space-y-3">
                            <div className="flex gap-3 items-start p-3 bg-amber-500/10 rounded-lg border border-amber-500/10">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">Prévue ce soir à 22h00</p>
                                </div>
                            </div>
                            <div className="flex gap-3 items-start p-3 bg-blue-500/10 rounded-lg border border-blue-500/10">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">5 messages non lus</p>
                                </div>
                            </div>
                            <div className="flex gap-3 items-start p-3 bg-emerald-500/10 rounded-lg border border-emerald-500/10">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">3 bulletins en attente</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div className="text-center p-3 bg-white/5 rounded-lg border border-white/5">
                                ...
                                <p className="text-xs text-gray-400">Comptes Actifs</p>
                            </div>
                            <div className="text-center p-3 bg-white/5 rounded-lg border border-white/5">
                                <p className="text-2xl font-bold text-white">124</p>
                                <p className="text-xs text-gray-400">Visites auj.</p>
                            </div>
                        </div>
                        <button className="w-full flex items-center justify-center gap-2 py-2 text-sm text-gray-300 hover:text-white bg-white/5 hover:bg-white/10 rounded-lg transition-colors">
                            <HelpCircle size={16} />
