            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <select className="bg-black/20 border border-white/10 text-xs text-gray-300 rounded px-2 py-1 outline-none">
                        ...
                        {[40, 65, 45, 80, 55, 90, 70, 85, 60, 75, 50, 95].map((h, i) => (
                            <div key={i} className="w-full flex flex-col justify-end gap-1 group cursor-pointer">
                                <div className="w-full bg-indigo-500/30 group-hover:bg-indigo-500/50 rounded-t-sm transition-all relative" style={{ height: `${h}%` }}>
                                    <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 border border-white/10">
                                        {h * 100}k FCFA
                                    </div>
                                </div>
                            </div>
                ...
                <div className="space-y-6">
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                        ...
                        <div className="space-y-4">
                            {[
                                { label: "Lycée", value: 45, color: "bg-purple-500" },
                    ...
                    <div className="bg-red-500/5 backdrop-blur-sm border border-red-500/20 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-red-100">Alertes Budget</h3>
                        </div>
