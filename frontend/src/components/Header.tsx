    ...
    <header className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white shadow-lg">
      <div className="container mx-auto flex items-center justify-between py-3 px-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center font-bold text-lg">SS</div>
          <div>
            <Link to="/dashboard" className="text-xl font-semibold tracking-tight">Smart School</Link>
          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                if (!t.src.includes('default-avatar.svg')) t.src = '/src/assets/default-avatar.svg';
              }}
            />
          </button>
            ...
            {open && (
              ...
              >
                <div className="py-2">
                  ...
                  <Link to="/profile#settings" className="block px-4 py-2 hover:bg-gray-100">Paramètres</Link>
                  <button onClick={handleLogout} className="w-full text-left px-4 py-2 hover:bg-gray-100">Se déconnecter</button>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
