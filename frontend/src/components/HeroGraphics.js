...
export default function HeroGraphics() {
    ...
    return (_jsx("div", { className: "my-10", children: _jsx("div", { className: "container mx-auto px-6 lg:px-20", children: _jsxs("div", { className: "relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-indigo-50 p-6 shadow-lg", children: [_jsx("h3", { className: "text-xl font-semibold text-gray-800 mb-4 text-center", children: "D\u00E9couvrir Smart School" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch", children: (() => {
                            ...
                            return visibleItems.map(({ item, idx }, pos) => {
                                ...
                                return (_jsxs(motion.div, { className: `p-4 rounded-xl bg-white border border-gray-100 shadow-sm`, initial: shouldReduceMotion ? undefined : 'hidden', animate: 'visible', variants: variants, transition: transition, whileHover: shouldReduceMotion ? {} : { scale: 1.03 }, children: [_jsx("div", { className: "h-36 flex items-center justify-center", children: item.lottieUrl ? (_jsx(motion.div, { className: "w-full h-full flex items-center justify-center", animate: shouldReduceMotion ? undefined : { y: [0, -6, 0] }, transition: shouldReduceMotion ? undefined : { duration: 3, repeat: Infinity, ease: 'easeInOut' }, children: _jsx(LottiePlayer, { url: item.lottieUrl, containerId: `lottie-${item.id}` }) })) : (_jsx(motion.div, { className: "w-20 h-20 rounded-full bg-indigo-500", animate: shouldReduceMotion ? undefined : { y: [0, -6, 0] }, transition: shouldReduceMotion ? undefined : { duration: 3, repeat: Infinity, ease: 'easeInOut' } })) }), _jsxs("div", { className: "mt-3", children: [_jsx("div", { className: "text-lg font-semibold text-gray-800", children: item.title }), _jsx("div", { className: "text-sm text-gray-500", children: item.subtitle })] }), _jsx("div", { className: "mt-3 flex items-center justify-end", children: _jsxs("div", { className: "text-xs text-gray-400", children: [idx + 1, "/", items.length] }) })] }, item.id));
                            });
