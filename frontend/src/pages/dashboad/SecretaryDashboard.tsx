...
const SecretaryDashboard: React.FC<SecretaryDashboardProps> = ({ user }) => {
  // Utiliser user.schoolId pour les requêtes multi-tenant (si besoin)
    // schoolId variable removed as it is unused

  return (
    <DashboardLayout>{/* ⬅️ le toast Bienvenue est géré ici */}
